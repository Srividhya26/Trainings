...
{
    public class EmployeeController : BaseController<EmployeesDetail>
    {
        ...
        {
            IEnumerable<EmployeesDetail> employees = _db.Employee.Where(x => x.DelStatus == 'A');
        ...
        public IActionResult Index(string searchText,string sortOrder)
        {
            ...
            var employee =  from emp in _db.Employee where emp.DelStatus == 'A' select emp;
